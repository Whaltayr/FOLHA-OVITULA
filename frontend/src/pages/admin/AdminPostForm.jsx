...
export default function AdminPostForm() {
  ...
  return (
    ...
    {/* === BOTÃO VOLTAR === */}
    <Link to="/admin/posts" className="inline-flex items-center text-gray-500 hover:text-blue-600 mb-6 transition font-medium">
      <FaArrowLeft className="mr-2" /> Voltar à Lista
    </Link>
